return {
    ...
    config = function()
        ...
        wk.add({
            ...
            { "<leader>at", ":TSJToggle<CR>",                                              desc = "Split/Join" },
            { "<leader>aq", ":ToggleQuotes<CR>",                                           desc = "Toggle Quotes" },

            -- Olympe
            { "<leader>o",  group = "Olympe" },
            { "<leader>oc", ":wa<CR> :!(cd ~/Documents/olympe/composer;npm run data)<CR>", desc = "Save Composer" },

            -- LSP
            { "<leader>l",  group = "LSP" },
            { "<leader>lh", vim.lsp.buf.hover,                                             desc = "Hover" },
            { "<leader>ld", require("telescope.builtin").lsp_definitions,                  desc = "Definitions" },
            { "<leader>li", require("telescope.builtin").lsp_implementations,              desc = "Implementations" },
